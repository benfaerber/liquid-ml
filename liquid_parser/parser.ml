...
let parse_cycle _ all_tokens =
  ...
  | Tokens.Cycle :: LexValue (LexString name) :: Colon :: tl ->
      parse_state (Some name) tl
...
let rec first_successful block_parser tokens = function
